...
//     private bool sceneReady = true; // kan je later koppelen aan scene loading
//
//     void Start()
//     {
...
//
//         // Rotatie via physics
//         rb.MoveRotation(Quaternion.RotateTowards(rb.rotation, Quaternion.Euler(xAngle, yAngle, zAngle), rotationSpeed * Time.fixedDeltaTime));
//
//         // Vooruit bewegen via physics
//         rb.MovePosition(rb.position + rb.transform.forward * speed * Time.fixedDeltaTime);
//     }
//
//     void Update()
//     {
//         TimerUntilNewDirection();
//     }
//
...
//     }
//
//     private void TimerUntilNewDirection()
//     { 
...
//         rb.MoveRotation(Quaternion.LookRotation(away), rotationSpeed * Time.fixedDeltaTime);
//     }
//
//
